...
*   [5. Capacity Adaptation and Degraded Operation](5_capacity_adaptation.md): What happens when $\sum u_i < N \cdot B$ — the per-tree sustainable layer set, SVC layer shedding, $D_{\text{max}}$ overflow, the publisher-side layer fold, and the source base-layer reserve.
