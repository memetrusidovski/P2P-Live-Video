...
*   [3. Registration Frame Layout](3_registration_frames.md): the Peer Record, `REGISTER_PEER`, `GET_PEERS`, `STORE_RECORD`/`STORE_RECORD_ACK` and the canonical Stream Record.
